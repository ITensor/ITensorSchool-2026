...
\definecolor{msggrey}{HTML}{8C8C8C}
...
\tikzset{
  ...
  msg/.style={isosceles triangle,isosceles triangle apex angle=75,draw,line width=1.5pt,fill=msggrey,inner sep=0,
              minimum width=4.5mm,minimum height=5.5mm,shape border rotate=0},
  ...
  msgmat/.style={msg,minimum width=5.5mm,minimum height=7mm},
  % a partially contracted intermediate: bigger than a single tensor
  blob/.style={circle,draw,line width=1.5pt,fill=tensorblue!55!msggrey,minimum size=14mm,inner sep=0},
