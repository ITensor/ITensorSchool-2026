...
both the Bethe-Peierls free energy density using belief propagation (your implementation
from Tutorial 2 in `belief_propagation.jl`) and a loop-corrected free energy density.
