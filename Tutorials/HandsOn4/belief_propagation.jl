...
You are asked to complete the belief propagation (BP) algorithm in this file. For each
numbered step (1), (2), (3) below, fill in the missing code. The other functions are
complete. Tutorials 3 and 4 also use this file, so they only give correct answers once
